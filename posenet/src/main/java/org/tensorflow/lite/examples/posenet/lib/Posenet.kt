...
import ai.vsm.aretna.MODEL_HEIGHT
import ai.vsm.aretna.MODEL_WIDTH
...
//  }
  ...
  private fun loadModelFile(path: String, context: Context): MappedByteBuffer {
   ...
   fun print(vale:String) {
    Log.i("IN POSENET",vale)
  }
  ...
  fun estimateSinglePose(bitmap: Bitmap):Person {
    ...
    Log.e("person", jsonString);
    Log.v("BITMAOANDPERSON",person.toString())
